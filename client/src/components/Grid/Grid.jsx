...
const GridItem = () => {
    ...
    return (
        <Grid container 
            ...
            >
                <Box className="card">
                    <img src="https://res.cloudinary.com/dh6o5rpfe/image/upload/v1660155599/sushi-shop/main/Grid/Corndog_l9yfim.jpg" 
                    className='card_image' alt=""/>
                    <Typography className='card_text' component="h3">Corn Dogs</Typography>
                </Box>
            </Grid>
            <Grid item md={6} sm={12} xs={12}
            >
            ...
            <Grid item className="grid_block_item" md={6} sm={12} xs={12}
            >
                <Box className="card">
