...
function SushiCard({item}){
  ...
  boxShadow:"none"
   ...
   <Typography variant="body2" component="div" color="text.secondary" className="blockquote" sx={{ background:"white", borderRadius:"50%",width:200, height:200,display:"flex",justifyContent:"center", alignItems:"center", alignSelf:"center" 
  }}>
  <NavLink
						style={{
							textDecoration: 'none',
