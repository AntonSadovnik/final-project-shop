...
function OfferSliderSkeleton() {
  ...
  useEffect(()=>{
		...
		content = (
			<Box
				...
				sx={{
					...
					alignItems: 'flex-end',
					width: '100%',
					height: { sm: 'none', md: 525, lg: 525, xl: 525 },
				}}
			>
				<Stack
					component="span"
					...
					sx={{
						bgcolor: 'grey.400',
						borderRadius: '20px',
						width: { sm: '56vw', md: '81.5vw', lg: '940px', xl: '940px' },
						height: { md: 470, lg: 470, xl: 470 },
					}}
				>
					<Skeleton
						component="span"
						variant="rectangular"
						sx={{ bgcolor: 'grey.600', marginLeft: '30px' }}
						width="450px"
						height="250px"
					/>
					...
					>
						<Skeleton
							component="span"
							variant="text"
							sx={{ fontSize: '35px', bgcolor: 'grey.600' }}
							width="220px"
						/>
						<Skeleton
							component="span"
							variant="text"
							sx={{ fontSize: '22px', bgcolor: 'grey.600', marginTop: '-55px' }}
							width="70px"
						/>
						<Typography>
							<Skeleton
							...
							<Skeleton
								component="span"
								variant="text"
								sx={{ fontSize: '40px', bgcolor: 'grey.600' }}
								width="100px"
							/>
						</Typography>
   ...
   if(!items){
    ...
    <Stack  component="span" className='slider-wrapper' direction="row" justifyContent="center" alignItems="center" maxWidth="950px"  height={470} sx={{ bgcolor:'grey.400', borderRadius:'20px', width:{sm:'56vw',md:'81.5vw',lg:'940px',xl:'940px' }, height:{md:470,lg:470,xl:470} }}>
