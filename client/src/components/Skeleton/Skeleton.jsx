...
function OfferSliderSkeleton() {
  ...
  useEffect(()=>{
   ...
   if(!items){
    ...
    <Stack className='slider-wrapper' direction="row" justifyContent="center" alignItems="center" maxWidth="950px" width="81vw" height={475} sx={{ bgcolor:'grey.400', borderRadius:'20px',paddingTop:'10px' }}>
