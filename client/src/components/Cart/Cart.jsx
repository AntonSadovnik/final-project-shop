    ...
    return (
        <div >
            ...
            <Dialog
                            ...
                            arr.map(i=><div>
                                <Box sx={{
                                    ...
                                    <Box sx={{
                                        ...
                                        <img style={matches?{maxWidth: '2rem', marginRight:"2px",
                                            height: '2rem'}:{maxWidth: '5rem', marginRight:"5px",
                                            height: '3rem'}} src={i[1]}  alt="susi" />
                                        <Typography id="modal-modal-description" sx={matches?{  ml: 1, fontSize:"10px" }:{  ml: 3 }}>
                                            {i[0]}
                                        </Typography>
                                    </Box>
                                    <Box sx={{display: "flex", alignItems: 'center'}}>
                                        ...
                                        <Typography id="modal-modal-amount" variant="body2" component="text1"  >
                                            {i[2]}
                                        </Typography>
                                        <IconButton aria-label="delete" >
                                            <AddCircleOutlineIcon color='secondary' fontSize={matches? "small": "medium"}/>
                                        </IconButton>
                                        <Typography  variant="body2" component="text1" marginX={matches?'.1rem':'2rem'}  >
                                            {i[2]*i[3]}$
                                        </Typography>
                                        <IconButton aria-label="delete">
                ...
                <DialogActions>
                    <Typography variant="h6" component="text1" color="black" sx={{mr:"2rem"}}>1500$</Typography>
                    <Button variant="contained" color='secondary' size={matches?'small':'medium'} onClick={handleClose}>Checkout</Button>
                </DialogActions>
            </Dialog>
        </div>
    );
